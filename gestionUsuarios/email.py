...
from Sis_aprendizaje.settings import EMAIL_HOST_USER
from .models import Submissions,Assignments,Classrooms,Students,colaborador
...
def submission_marks_mail(submission_id,teacher_id,marks):
    teacher_name = colaborador.objects.get(pk=teacher_id).username
